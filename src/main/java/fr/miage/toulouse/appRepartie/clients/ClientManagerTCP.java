...
public class ClientManagerTCP {
    public static void main(String[] args) {
        ...
        try{
            sockClient = new Socket("localhost", 28415);
            System.out.println("Connecté au serveur avec port 28415");
            ...
            try{
                ...
                System.out.println("Entrer la requete avec le format : 'CHK/ADD/DEL/MOD login password' ou Entrer FIn pour arreter.");
                requete = sc.nextLine();
